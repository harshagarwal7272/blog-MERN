...
class PostTemplate extends Component {
	render() {
        ...
        const { _id, author, authorEmail, authorUserName, title, description, read_duration, date, imageData } = this.props.postFromAuthor;
                            ...
                            <a href={ "/author/" + authorUserName }>
                                ...
                                <div className="card-block">
                                    ...
                                    <div className="metafooter">
                                        ...
                                        <span className="post-name"><a href={ "/author/" + authorUserName }>{ author }</a></span><br/>
...
PostTemplate.propTypes = {
	...
	postFromAuthor: PropTypes.object.isRequired
}

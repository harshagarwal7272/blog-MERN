				...
				<Container>
					<ListGroup>
						<TransitionGroup className="">
							{posts.map(({ _id, author, title, description, read_duration, date }) => (
								<CSSTransition key={_id} timeout={0}>
									<ListGroupItem>
										<div className="card">
											<div className="row">
												<div className="col-md-5 wrapthumbnail">
														<div className="thumbnail" style={{backgroundImage:"url(./../../uploads/1.jpg)"}}>
														</div>
												</div>
													...
													<div className="card-block">
														...
														<div className="metafooter">
															<div className="wrapfooter">
																...
																<span className="post-date">{ date }</span><span className="dot"></span><span className="post-read">{ read_duration } min read</span>
																</span>
